...
public class ElementParser {
   ...
   public static func debug(element: XCUIElement, indentation: String = "") {
      Swift.print("\(indentation)identifier:  \(element.identifier) accessibilityLabel:  \(String(describing: element.accessibilityLabel)) label:  \(element.label) type:  \(String(describing: XCUIElement.ElementType.init(rawValue:  element.elementType.rawValue))) title:  \(element.title)")
   }
   /**
